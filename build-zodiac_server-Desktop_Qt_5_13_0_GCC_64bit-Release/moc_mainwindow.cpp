...
void AstroFileInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AstroFileInfo *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (AstroFileInfo::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AstroFileInfo::clicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject AstroFileInfo::staticMetaObject = { {
    &AstroFileHandler::staticMetaObject,
    qt_meta_stringdata_AstroFileInfo.data,
    qt_meta_data_AstroFileInfo,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AstroWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (AstroWidget::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AstroWidget::helpRequested)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (AstroWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AstroWidget::appendFileRequested)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (AstroWidget::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AstroWidget::swapFilesRequested)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject AstroWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_AstroWidget.data,
    qt_meta_data_AstroWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AstroDatabase *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (AstroDatabase::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AstroDatabase::fileRemoved)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (AstroDatabase::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AstroDatabase::openFile)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (AstroDatabase::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AstroDatabase::openFileInNewTab)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (AstroDatabase::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AstroDatabase::openFileAsSecond)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject AstroDatabase::staticMetaObject = { {
    &QFrame::staticMetaObject,
    qt_meta_stringdata_AstroDatabase.data,
    qt_meta_data_AstroDatabase,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FilesBar *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject FilesBar::staticMetaObject = { {
    &QTabBar::staticMetaObject,
    qt_meta_stringdata_FilesBar.data,
    qt_meta_data_FilesBar,
    qt_static_metacall,
    nullptr,
    nullptr
} };
