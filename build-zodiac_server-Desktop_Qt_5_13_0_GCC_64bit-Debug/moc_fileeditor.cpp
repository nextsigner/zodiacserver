...
void AstroFileEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AstroFileEditor *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (AstroFileEditor::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AstroFileEditor::windowClosed)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (AstroFileEditor::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AstroFileEditor::appendFile)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (AstroFileEditor::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AstroFileEditor::swapFiles)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject AstroFileEditor::staticMetaObject = { {
    &AstroFileHandler::staticMetaObject,
    qt_meta_stringdata_AstroFileEditor.data,
    qt_meta_data_AstroFileEditor,
    qt_static_metacall,
    nullptr,
    nullptr
} };
