...
void AstroFile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AstroFile *_t = static_cast<AstroFile *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (AstroFile::*_t)(AstroFile::Members );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AstroFile::changed)) {
                *result = 0;
            }
        }
        {
            typedef void (AstroFile::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AstroFile::destroyRequested)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject AstroFile::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_AstroFile.data,
      qt_meta_data_AstroFile,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AstroFile::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AstroFile.stringdata0))
        return static_cast<void*>(const_cast< AstroFile*>(this));
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AstroFileHandler *_t = static_cast<AstroFileHandler *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (AstroFileHandler::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AstroFileHandler::requestHelp)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject AstroFileHandler::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AstroFileHandler.data,
      qt_meta_data_AstroFileHandler,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AstroFileHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AstroFileHandler.stringdata0))
        return static_cast<void*>(const_cast< AstroFileHandler*>(this));
    if (!strcmp(_clname, "Customizable"))
        return static_cast< Customizable*>(const_cast< AstroFileHandler*>(this));
