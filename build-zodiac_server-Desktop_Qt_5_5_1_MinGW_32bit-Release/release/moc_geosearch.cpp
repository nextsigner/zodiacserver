...
void GeoSuggestCompletion::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        GeoSuggestCompletion *_t = static_cast<GeoSuggestCompletion *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject GeoSuggestCompletion::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GeoSuggestCompletion.data,
      qt_meta_data_GeoSuggestCompletion,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GeoSuggestCompletion::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GeoSuggestCompletion.stringdata0))
        return static_cast<void*>(const_cast< GeoSuggestCompletion*>(this));
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        GeoSearchBox *_t = static_cast<GeoSearchBox *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject GeoSearchBox::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_GeoSearchBox.data,
      qt_meta_data_GeoSearchBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GeoSearchBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GeoSearchBox.stringdata0))
        return static_cast<void*>(const_cast< GeoSearchBox*>(this));
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        GeoSearchWidget *_t = static_cast<GeoSearchWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (GeoSearchWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GeoSearchWidget::locationChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject GeoSearchWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_GeoSearchWidget.data,
      qt_meta_data_GeoSearchWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GeoSearchWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GeoSearchWidget.stringdata0))
        return static_cast<void*>(const_cast< GeoSearchWidget*>(this));
