/****************************************************************************
** Meta object code from reading C++ file 'slidewidget.h'
**
...
#include "../../zodiacserver/src/slidewidget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'slidewidget.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 12, 19), // "currentSlideChanged"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 9), // "nextSlide"
QT_MOC_LITERAL(4, 43, 14) // "transitionDone"

    },
    "SlideWidget\0currentSlideChanged\0\0"
    "nextSlide\0transitionDone"
};
...
void SlideWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SlideWidget *_t = static_cast<SlideWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->currentSlideChanged(); break;
        case 1: _t->nextSlide(); break;
        case 2: _t->transitionDone(); break;
        default: ;
        }
        ...
        {
            typedef void (SlideWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SlideWidget::currentSlideChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject SlideWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SlideWidget.data,
...
// SIGNAL 0
void SlideWidget::currentSlideChanged()
{
